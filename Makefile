...
FREE_LIBS = -L/usr/local/lib -lfreenect -L/Applications/matlab/MATLAB_Compiler_Runtime/v81/runtime/maci64 -L/Users/giu/Documents/GRobot/Code/video/lib -lmwmclmcrrt -lsegmentImage
CXX = c++
